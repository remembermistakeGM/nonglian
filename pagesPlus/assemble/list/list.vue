<template>
	<view class="assemble-container">
		<view class="top-box">
			...
			<!--图片-->
			<view class="banner-image d-c-c" v-if="listData && listData.detail&&categorys.length>0">
				<image :src="listData.detail.file_path"></image>
			</view>
			<!--活动时间-->
			<view class="ad-datetime p-30-0 d-c-c pb0" v-if="listData && listData.detail&&categorys.length>0">
