  ...
  methods: {
    ...
    updateSpecProduct() {
      ...
      if (typeof skuItem === "object") {
        let point_sku_list = self.form.detail.bargainSku, bargainSkuItem = point_sku_list.find((val) => {
    ...
    createdOrder() {
      ...
      self._get(
        ...
        function(res) {
          ...
          self.gotoPage("/pagesPlus/bargain/haggle/haggle?bargain_task_id=" + bargain_task_id + "&order_type=bargain");
        }
      );
    },
    /*商品增加*/
...
function _sfc_render(_ctx, _cache, $props, $setup, $data, $options) {
  return common_vendor.e({
    ...
    c: common_vendor.t($data.form.show_sku.bargain_price),
    d: common_vendor.t($data.form.show_sku.line_price)
  } : {
    e: common_vendor.t($data.form.detail.bargain_price)
  }, {
    f: common_vendor.t($data.form.show_sku.bargain_stock),
...
const Component = /* @__PURE__ */ common_vendor._export_sfc(_sfc_main, [["render", _sfc_render], ["__file", "D:/workspace/p/nc/nc_app/pagesPlus/bargain/detail/popup/Spec.vue"]]);
