	...
	<div>
		...
		<template v-if="!extract_store.store_id">
			<view class="add-address d-s-c" @click="addAddress()">
				<view class="icon-box mr10"><text class="icon iconfont icon-dizhi1"></text></view>
				<text>请选择自提点</text>
			</view>
		</template>
		<template v-else>
			<view class="address-defalut-wrap">
				...
				<view class="address">
					...
					<view class="icon-box" @click="addAddress()"><text class="icon iconfont icon-jiantou"></text></view>
				</view>
				<view class="user">
