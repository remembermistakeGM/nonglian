						...
						<view class="coupon-item" :class="'coupon-item-' + item.color.text">
							<view class="operation d-b-c">
								...
								<view class="right-box d-c-c d-c">
									<view class="theme-price mb10" v-if="item.coupon_type == 10">
										<text class="f24">￥</text>
										<text class="f52 fb">{{ item.reduce_price * 1 }}</text>
									</view>
									<view class="mb10 theme-price" v-if="item.coupon_type == 20">
									...
									<view v-if="item.is_get == 0" class="f26 coupon-btn theme-btn" @click="receiveCoupon(index)">领取</view>
									<button type="default" v-else class="f26 coupon-btn btn-gray white" v-on:click.stop>已领取</button>
								</view>
							</view>
						</view>
						<view
							...
							@click.stop="gotoPage('/pages/coupon/detail?coupon_id=' + item.coupon_id + '&applyRange=' + item.apply_range)"
						>
					...
					<view class="d-s-s d-c p20 mpservice-wrap" v-if="!isloding">
						...
						<template v-if="dataModel != null">
							<view v-if="dataModel.qq != ''" class="d-b-c p-30-0 f34 ww100 border-b" @click="copyQQ(dataModel.qq)">
								<image src="/static/icon/concat1.png" mode="widthFix" class="imgIcon"></image>
							...
							<view v-if="dataModel.wechat != ''" class="d-b-c p-30-0 f34 ww100 border-b" @click="copyQQ(dataModel.qq)">
								<image src="/static/icon/concat3.png" mode="widthFix" class="imgIcon"></image>
								<view class="p-0-30 flex-1">
									<view>官方微信</view>
							...
							<view v-if="dataModel.phone != ''" class="d-b-c p-30-0 f34 ww100" @click="callPhone(dataModel.phone)">
								<image src="/static/icon/concat2.png" mode="widthFix" class="imgIcon"></image>
								<view class="p-0-30 flex-1">
									<view>官方热线</view>
