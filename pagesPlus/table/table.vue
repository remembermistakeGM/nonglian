	...
	<view  :data-theme='theme()' :class="theme() || ''"  v-if="!loading">
		<view v-for="(item,index) in tableData" :key='index'>
			...
			<template v-if="item.type == 'radio-group'">
				...
				<view class="uni-list">
					<checkbox-group @change="changeRadioGroup($event,index)">
						<label class="d-s-c make-item mb20" v-for="(ritem,rindex) in getName(item.select_value)" :key='ritem'>
							<view>
			...
			<template v-if="item.type == 'select'">
				...
				<view class="table-item">
					...
					<view class="uni-list">
						<picker class=""  @change="changeSelect($event,index)"
			...
			<template v-if="item.type == 'date'">
				...
				<view class="table-item">
					...
					<view class="uni-list">
						<picker class="datapicker" mode="date"  @change="changeDate($event,index)">
			...
			<template v-if="item.type == 'time'">
				...
				<view class="table-item">
					...
					<view class="uni-list">
						<picker class="datapicker" mode="time"  @change="changeDate($event,index)">
							<view class="make-item selectpicker input-box">{{item.value || '请选择'}}</view>
						</picker>
					</view>
				</view>
			...
			<template v-if="item.type == 'area'">
				...
				<view class="table-item">
					...
					<view class="uni-list make-item">
						<view class="input-box flex-1 selectpicker mb20" @click="changeArea(index)">
							<input class="" type="text" placeholder-class="grary9" placeholder="请选择地区"
								v-model="item.value " disabled="true" style="pointer-events: none" />
						</view>
