		...
		<view class="form-wrap f30">
			<form @submit="formSubmit" @reset="formReset">
				<view class="p-0-20 pt30 txje">
					...
					<text class="f26 gray9 ml30">{{ words.cash_apply.words.min_money.value + settlement.min_money + '元' }}</text>
				</view>
				<view class="p-0-20 ">
					<view class="withd-bc">
						...
						<view class="withd-bcb">
							{{ words.cash_apply.words.capital.value }}{{ agent.money }}元,
						...
						<template v-if="hasType('20')">
							<view class="p-30-0 border-b">
								...
								<template v-if="withdraw_type == 20">
									<view class="mt20"><input class="p20 border-tb" name="alipay_name" type="text" placeholder-class="grary" placeholder="请输入姓名" /></view>
									<view class="mt20">
										<input class="p20 border-tb" name="alipay_account" type="text" placeholder-class="grary" placeholder="请输入支付宝账号" />
									</view>
								</template>
							</view>
						</template>
						<template v-if="hasType('30')">
							<view class="p-30-0 border-b">
								...
								<template v-if="withdraw_type == 30">
									<view class="mt20"><input class="p20 border-tb" name="bank_account" type="text" placeholder-class="grary" placeholder="请输入姓名" /></view>
									<view class="mt20">
										<input class="p20 border-tb" name="bank_name" type="text" placeholder-class="grary" placeholder="请输入开户行名称/地址" />
									</view>
									<view class="mt20"><input class="p20 border-tb" name="bank_card" type="text" placeholder-class="grary" placeholder="请输入银行卡号" /></view>
								</template>
							</view>
						</template>
					</view>
