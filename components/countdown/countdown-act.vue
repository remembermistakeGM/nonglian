<template>
	...
	<view class="countdown" :style="'color:'+color" :class="activeName">
		...
		<template v-if="config.type == 'hours'">
			<text style="white-space: nowrap;" class="mr10">{{title}}</text>
			<text class="box" :style="'background: '+back_color+';color:'+cut_color+';border-radius: 6rpx;padding: 4rpx;line-height: 1;font-size:24rpx;'">{{ parseInt(day * 24) + parseInt(hour) }}</text>
			<text class="p-0-10" :style="'color:'+color">:</text>
			<text class="box"  :style="'background: '+back_color+';color:'+cut_color+';border-radius: 6rpx;padding: 4rpx;line-height: 1;font-size:24rpx;'">{{ minute }}</text>
			<text class="p-0-10" :style="'color:'+color">:</text>
			<text class="box"  :style="'background: '+back_color+';color:'+cut_color+';border-radius: 6rpx;padding: 4rpx;line-height: 1;font-size:24rpx;'">{{ second }}</text>
			<text class="p-0-10" :style="'color:'+color"></text>
		</template>
